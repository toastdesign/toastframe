...
function mytheme_require_plugins() {
    ...
    $config = array( 
        ...
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', 'toastframe' ),
            'menu_title'                      => __( 'Install Plugins', 'toastframe' ),
            'installing'                      => __( 'Installing Plugin: %s', 'toastframe' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'toastframe' ),
